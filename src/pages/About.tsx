      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-text-light mb-8">
            Get your Quote or Call <a href="tel:+91 9259684171" className="text-orange-brand hover:underline">+91 9259684171</a>
          </p>
          <Button 
            variant="wellvest" 
            size="lg" 
            onClick={() => window.open('https://dashboard.wellvest.in', '_blank')}
          >
            Start Now
          </Button>
        </div>
