            ...
            >
              ...
              <ul className="space-y-4">
                ...
                >
                  ...
                  <span className="text-gray-300">10th Floor, Sundervan Complex, Lokhandwala, Mumbai 400053</span>
                </motion.li>
                <motion.li 
                ...
                >
                  ...
                  <a href="tel:+919259684171" className="text-gray-300 hover:text-orange-brand transition-colors">+91 9259684171</a>
                </motion.li>
                <motion.li 
                  className="flex items-center"
                  initial={{ opacity: 0, x: -20 }}
