import { Phone, Mail, Facebook, Twitter, Instagram, Youtube, Linkedin, MessageCircle, Send } from 'lucide-react';
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-center text-sm">
          <div className="flex items-center space-x-6">
            ...
            >
              ...
              <a href="tel:+91 9259684171" className="hover:text-orange-brand transition-colors">
                +91 9259684171
              </a>
            </motion.div>
            <motion.div 
      ...
      <div className="fixed bottom-6 left-6 z-50 flex flex-col space-y-4">
        ...
        <motion.a 
          href="https://t.me/Wellvest" 
          target="_blank" 
          rel="noopener noreferrer"
          className="bg-[#0088cc] hover:bg-[#006699] text-white p-3 rounded-full shadow-lg"
          whileHover={{ scale: 1.15, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
          whileTap={{ scale: 0.95 }}
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
